...
export default function Page() {
  ...
  // Function to toggle the openEmployment stateimport { useState, useRef, useEffect } from "react";
import Link from "next/link";
import Image from "next/image";
import Dropdown from "react-bootstrap/Dropdown";
          ...
          <div className="flip-card-inner relative w-full h-full">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-red-300  rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-12">
                ...
                <div className="text-red-300  font-bold text-lg lg:text-3xl text-center">
                  Software Developer
                </div>
              </div>
            </div>
          ...
          <div className="flip-card-inner relative w-full h-full">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-react-color  rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-8">
                ...
                <div className="text-react-color  font-bold text-lg lg:text-3xl text-center">
                  Web & App Development
                </div>
              </div>
            </div>
          ...
          <div className="flip-card-inner relative w-full h-full ">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-custom-lboro rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-8">
                ...
                <div className="text-custom-lboro  font-bold text-xl lg:text-3xl text-center">
            ...
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-black rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-12">
                <img
                  ...
                  className="w-8/12  rounded shadow mr-3"
                ></img>
                <div className="text-black font-bold text-lg lg:text-3xl text-center">
                  Movement Clinics
                </div>
              </div>
            </div>
          ...
          <div className="flip-card-inner relative w-full h-full">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-sigma-color rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-12">
                ...
                <div className="text-sigma-color font-bold text-lg lg:text-3xl text-center">
          ...
          <div className="flip-card-inner relative w-full h-full">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-purple-300 rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-12">
                ...
                <div className="text-purple-300 font-bold text-lg lg:text-3xl text-center">
